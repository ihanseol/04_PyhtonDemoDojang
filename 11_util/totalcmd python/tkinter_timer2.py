...
class Application(tk.Frame):
    ...
    def __init__(self, master, time=0, *args, **kwargs):
...
if __name__ == "__main__":
    ...
    args = sys.argv
    arg1 = args[1] if len(args) > 1 else 0
    print(f"this is arg1 {arg1}")
    time_seconds = int(arg1)

    root = tk.Tk()
    root.title("TIMER")
    Application(root, time_seconds).pack(side="top", fill="both", expand=True)
    root.mainloop()
