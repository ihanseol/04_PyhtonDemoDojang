...
from pdf_industrial_engine import get_data_hanwool
from pdf_industrial_engine import get_data_kiwii
from pdf_industrial_engine import get_data_malgeunmul
from pdf_industrial_engine import get_data_nurilife

BASE_DIR = Path("d:/05_Send")
TEMPLATE_DIR = Path("c:/Program Files/totalcmd/hwp")
HWP_TEMPLATE = "wt_industrial.hwp"
...
class WaterQualityProcessor:
    ...
    def __init__(self,
                 ...
                 template_path: str = r"c:\Program Files\totalcmd\hwp\wt_industrial.hwp",
    ...
    def process_pdf(self, pdf_path: str) -> List[Path]:
        ...
        for page_num in range(1, page_count + 1):
            ...
            # Create document
            output_path = self.output_dir / f"ex_industrial_{well_id}.hwp"
