...
class WaterQualityData:
    ...
    REQUIRED_FIELDS = [
        'Total_Coliform', 'pH', 'Chloride', 'Nitrate_Nitrogen',
        'Cadmium', 'Arsenic', 'Cyanide', 'Mercury',
        'Parathion', 'Diazinon', 'Phenol', 'Lead', 'Chromium',
        '1,1,1-Trichloroethane', 'Tetrachloroethylene',
        'Trichloroethylene', 'Benzene', 'Toluene',
        'Ethylbenzene', 'Xylene', 'water_ok'
    ]
    ...
    def __init__(self, data: Dict[str, str]):
        ...
        # Microbiological
        self.total_coliform = data['Total_Coliform']
        ...
        self.benzene = data['Benzene']
        self.toluene = data['Toluene']
        self.ethylbenzene = data['Ethylbenzene']
        self.xylene = data['Xylene']
...
class HWPDocumentWriter:
    ...
    def create_document(self, well_id: str, water_data: WaterQualityData,
        ...
        try:
            ...
            self.write_field(hwp, 'ecoli', water_data.total_coliform)
...
class WaterQualityProcessor:
    ...
    def __init__(self,
                 ...
                 template_path: str = r"c:\Program Files\totalcmd\hwp\wt_domestic.hwp",
    ...
    def process_pdf(self, pdf_path: str) -> List[Path]:
        ...
        for page_num in range(1, page_count + 1):
            ...
            # Create document
            output_path = self.output_dir / f"ex_domestic_{well_id}.hwp"
