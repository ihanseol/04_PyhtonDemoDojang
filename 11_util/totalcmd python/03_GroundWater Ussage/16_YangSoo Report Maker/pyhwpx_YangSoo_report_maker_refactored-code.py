...
class WellType:
    ...
    def determine_well_type(self):
        ...
        # Check if dangye (step) data is included by looking for specific jpg files
...
class ReportGenerator:
    ...
    DATA_BASE_DIR = Path("D:\\09_hardRain\\10_ihanseol - 2025\\00_data\\04_Reference Data\\12_보고서, 부록\\A3_YangSoo_Report")
