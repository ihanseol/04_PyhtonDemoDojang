...
excel = pd.read_excel(r"C:\Users\minhwasoo\Desktop\award_list.xlsx")  # 엑셀로 데이터프레임 생성
...
shutil.copyfile(r"C:\Users\minhwasoo\Desktop\award(field).hwp",  # 원본은 그대로 두고,
                r"C:\Users\minhwasoo\Desktop\award_result.hwp")  # 복사한 파일을 수정하려고 함.

hwp.Open(r"C:\Users\minhwasoo\Desktop\award_result.hwp")  # 수정할 한/글 파일 열기
